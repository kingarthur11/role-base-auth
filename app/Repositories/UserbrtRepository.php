...
class UserbrtRepository extends BaseRepository
{
    ...
    public function createBrt($request)
    {
        ...
        $data = [
            'message' => 'New BRT BLUME COIN has been created',
            'user_id' => $user->id,
        ];
    ...
    public function update($request, $id) {
        ...
        $data = [
            'message' => 'BRT BLUME COIN has been updated'
        ];
        event(new YourEventName($data));
        // event(new YourEventName('New BRT BLUME COIN has been updated'));
        return ['data' => [], 'message' => "User brt detail updated successfuly", 'status' => true];
    }
    ...
    public function destroy($id) {
        ...
        $data = [
            'message' => 'BRT BLUME COIN has been deleted',
            'user_id' => $user->id,
        ];
        event(new YourEventName($data));
        // event(new YourEventName('New BRT BLUME COIN has been deleted'));
